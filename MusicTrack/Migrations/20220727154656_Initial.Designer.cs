...
namespace MusicTrack.Migrations
{
    ...
    [Migration("20220727154656_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MusicTrack.Models.PlayList", b =>
                {
                    ...
                    b.Property<string>("TrackPosition")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("MusicTrack.Models.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MusicTrack.Models.UserRole", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("MusicTrack.Models.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("MusicTrack.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MusicTrack.Models.UserRole", b =>
                {
                    b.HasOne("MusicTrack.Models.Role", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MusicTrack.Models.User", "User")
                        .WithMany("UserRoles")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
